 ...
 */
final class Version20181126150757 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE posseder (id INT AUTO_INCREMENT NOT NULL, praticiens_id INT DEFAULT NULL, specialite_id INT DEFAULT NULL, pos_diplome DATE NOT NULL, INDEX IDX_62EF7CBA3D329473 (praticiens_id), INDEX IDX_62EF7CBA2195E0F0 (specialite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE praticien (id INT AUTO_INCREMENT NOT NULL, type_code_id INT DEFAULT NULL, pra_num INT NOT NULL, pra_nom VARCHAR(255) NOT NULL, pra_adr LONGTEXT DEFAULT NULL, pra_cp INT DEFAULT NULL, pra_ville VARCHAR(255) DEFAULT NULL, pra_coefnotoriete DOUBLE PRECISION DEFAULT NULL, INDEX IDX_D9A27D3FFB91E2 (type_code_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
